...
export const TEAM_GALLERY: TeamGalleryItem[] = [
  {
    ...
    description: 'Executive leadership, managing directors, and senior partners convening to direct sovereign financing and global expansion.',
  ...
  },
  {
    ...
    description: 'Coordinating strategic venture partnerships, technological integration, and cross-border fund syndication.',
    gridSpan: 'lg:col-span-7',
    heightClass: 'h-[560px] sm:h-[620px] lg:h-[640px]',
    objectPosition: 'object-center',
  },
  ...
  },
  {
    ...
    description: 'Structured alignment sessions connecting multidisciplinary leads across Singapore, London, Guangzhou, and Lagos.',
    gridSpan: 'lg:col-span-6',
    heightClass: 'h-[500px] sm:h-[540px] lg:h-[560px]',
    objectPosition: 'object-center',
  },
